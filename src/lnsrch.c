	...
	double *f, double stpmax, int *check, double (*func)(double []))
{
	...
	*check=0;
	...
	test=0.0;
        ...
        alamin=VBIG; 
        if(test!=0.)alamin=TOLX/test;
/*THE SIZE OF ALAM CAN BE USED TO DETERMINE THE STEP - MAKE IT SMALL AND THE STEP WILL
BE SMALL & WILL VERY SLOWLY APPROACH CONVERGENCE - SET TO 1 BEFORE */
        alam=1.10;
	for (;;) {
