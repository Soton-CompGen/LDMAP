...
if(useld==1)
{
  ...
  while(abcd_p1!=NULL)
    ...
    while(ldPtr!=NULL)
        {  
           if(strcmp(abcd_p1->locus,ldPtr->locus)==0){abcd_p1->kb1=ldPtr->xkb;abcd_p1->ldu1=ldPtr->xldu;if1=1;}
           if(strcmp(abcd_p1->locus2,ldPtr->locus)==0){abcd_p1->kb2=ldPtr->xkb;abcd_p1->ldu2=ldPtr->xldu;if2=1;}
           ldPtr=ldPtr->nextPtr;
        }
